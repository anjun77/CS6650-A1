...
public class Main2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Phase2 phase1 = new Phase2(1, threadsForPhase1, numSkiers, numLifts, startTime, endTime, postRequestsForEachThread,
...
//        phase1.waitTime();
        ...
        Phase2 phase2 = new Phase2(2, threadsForPhase2, numSkiers, numLifts, startTime, endTime, postRequestsForEachThread,
...
//        phase2.waitTime();
        ...
        Phase2 phase3 = new Phase2(3, threadsForPhase3, numSkiers, numLifts, startTime, endTime, postRequestsForEachThread,
