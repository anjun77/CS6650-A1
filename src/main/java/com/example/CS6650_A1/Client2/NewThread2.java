...
public class NewThread2 extends Thread{
  ...
  @Override
    public void run() {
      ...
      //local server: http://localhost:8080/CS6650_A1_war_exploded/
      //apiClient.setBasePath(this.serverAddress + "/CS6650_A1_war_exploded/skiers/");
      //ec2: http://3.88.202.132:8080/CS6650-A1_war/
      //apiClient.setBasePath(http://3.88.202.132:8080/CS6650-A1_war/);
